<div class="hidden w-4/12 -mx-8 lg:block">
    ...
    <div class="px-8 mt-10">
        ...
        @foreach ($posts as $post)
            ...
            <div class="flex flex-col max-w-sm px-8 py-6 mb-3 mx-auto bg-white rounded-lg shadow-md">
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex items-center"><img
                        ...
                        <a href="{{ route('posts.show', $post) }}" class="mx-3 text-sm text-gray-700 hover:underline">
                            {{ $post->user->name }}
                        </a>
                    </div>
                    <span class="text-sm font-light text-gray-600">{{ $post->created_at->format('d M. Y') }}</span>
                </div>
            </div>
        @endforeach
    </div>
